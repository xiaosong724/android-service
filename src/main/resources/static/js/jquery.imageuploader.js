...
(function ($) {
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<button class="js-uploader__submit-button uploader__submit-button uploader__hide" style="display:none;">' +
                ...
                selectButton: $('<input style="height: 0; width: 0;" name="file"  multiple accept="image/*" id="fileinput' + index + '" type="file"  class="js-uploader__file-input uploader__file-input">' +
