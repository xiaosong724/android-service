!function (e) {
    ...
    18: function (e, t, n) {
        ...
        var g = new (o = Object(p.a)({x: 4, y: 4}), Object(s.a)(r = o(r = function (e) {
            function t() {
                return O(this, t), v(this, w(t).apply(this, arguments))
            }

            return j(t, a["a"]), t//下面可加字
        }()) || r) || r), P = new u.a("", {color: "#0f070a", size: b.a.isMobile ? .5 : .8});
        P.position.x -= .5 * P.basePosition, g.add(P);
        var _ = ["#4062BB","#FF72DD", "#13fffc", "#23FF75", "#F45B69"].map(function (e) {
        ...
        }())({frequency: .5}, {width: .1, nbrOfPoints: 5});
        g.add(S), g.start();
        ...
        x.to(".overlay", .6, {autoAlpha: 0}), x.fromTo(g.lookAt, 3, {y: -4}, {
            y: 0,
            ease: Power3.easeOut
            ...
            }), t.add(P.hide, 0), t.add(S.stop), t.to(".overlay", .5, {autoAlpha: 1, onComplete: e}, "-=1.5")
        })
    }, 20: function (e, t, n) {
    }
});