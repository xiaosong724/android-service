...
public class ToImgUtil {
    ...
    public static void toSmaillImgback(MultipartFile filePath, String thumbPath,int imgsize) throws Exception{
        String newurl =thumbPath;
        java.awt.Image bigJpg = javax.imageio.ImageIO.read(filePath.getInputStream());
        float tagsize = imgsize;
        int old_w = bigJpg.getWidth(null);
        int old_h = bigJpg.getHeight(null);
        int new_w = 0;
        int new_h = 0;
